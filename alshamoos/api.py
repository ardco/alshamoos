...
def add_barcode(barcode, docname):
    ...
    frappe.set_value('Item Barcode Generator Counter', 'Item Barcode Generator Counter', 'barcode_counter', int(frappe.get_value('Item Barcode Generator Counter', 'Item Barcode Generator Counter', 'barcode_counter')) + 1)
